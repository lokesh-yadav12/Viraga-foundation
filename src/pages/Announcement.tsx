                ...
                <div className={`fade-up delay-2 ${visible ? 'visible' : ''} w-full`}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {[
                            ...
                            <div
                                key={i}
                                className="date-card bg-white rounded-2xl p-6 text-center glow-border cursor-default"
                            >
                                <div className="body-font text-xs text-orange-400 font-semibold uppercase tracking-widest mb-1">
                                    {d.label}
                                </div>
                                <div className="heading-font text-5xl font-black text-orange-600 leading-none">
                                    {d.day}
                                </div>
                                <div className="telugu text-lg text-gray-700 font-medium mt-1">
                                    {d.month} {d.year}
                                </div>
                                <div className="mt-3 w-10 h-1 bg-gradient-to-r from-orange-400 to-amber-400 rounded-full mx-auto" />
                            </div>
                        ))}
                    </div>
                </div>
