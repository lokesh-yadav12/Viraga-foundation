							...
							<Link to={folder.link} className="group cursor-pointer block">
								<div className="relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-orange-500/25 transition-all duration-700 bg-white transform hover:-translate-y-4 hover:scale-105">
									...
									<div className="relative bg-white rounded-3xl overflow-hidden">
										...
										<div className="absolute inset-0 bg-gradient-to-t from-slate-900/98 via-slate-900/70 to-transparent opacity-100 sm:opacity-0 group-hover:opacity-100 transition-all duration-700 flex flex-col items-center justify-end pb-10 rounded-3xl">
											<div className="text-center space-y-4 transform translate-y-0 sm:translate-y-8 group-hover:translate-y-0 transition-transform duration-700">
												<div className="inline-flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-xl rounded-full border border-white/30 shadow-2xl">
													<Calendar className="w-5 h-5 text-pink-400" />
													<span className="text-white font-bold text-lg">{folder.label}</span>
												</div>
