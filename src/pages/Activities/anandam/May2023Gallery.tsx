...
const FerryOrphanageFoodDonationGallery: React.FC = () => {
	...
	const nextItem = () => setLightboxIndex((i) => (i !== null ? (i + 1) % galleryItems.length : 0));
				...
				<section className="max-w-6xl mx-auto px-4 sm:px-6 pt-16 pb-12">
					...
					<div className="space-y-5 text-gray-600 leading-relaxed" style={{ fontSize: '1.05rem' }}>
						...
						>
							<div className="flex flex-row  gap-4 ">
								...
								<p className="font-semibold text-lg text-gray-800" style={{ fontSize: '0.95rem' }}>
									In Loving Memory
								</p>
							</div>
							<div>
                  ...
                  In Loving Memory
						...
						<p>
							...
							<strong className="text-gray-800">love, care, and the spirit of giving</strong>. Viraga
