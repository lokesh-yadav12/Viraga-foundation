      ...
      <div className="min-h-screen pt-16 w-full" style={{ background: '#ffffff', color: '#1c1c1c' }}>
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 pt-16 pb-12">
          ...
          <div className="flex sm:flex-row flex-col items-center gap-3 mb-6">
            ...
            <span className="text-gray-600 text-base font-semibold tracking-widest">May 2, 2023</span>
          </div>
          ...
          <div className="space-y-5 text-gray-900 text-base sm:text-lg leading-relaxed">
            <p>
              On{' '}
              <span className="font-semibold text-orange-700">May 2, 2023</span>,
              as part of the Food Donation Program, Viraga Foundation organized a special meal
              distribution drive at an orphanage home in{' '}
              <strong className="text-amber-900">Ferry, Ibrahimpatnam</strong>.
            </p>
            ...
            >
              <div className="flex flex-row gap-4">
                ...
                <p className="font-semibold text-base sm:text-lg text-amber-800">
                  In Loving Memory
                </p>
              </div>
              <div>
                <p className="text-gray-900 mt-1 text-base sm:text-lg">
                  ...
                  <strong className="text-amber-900">Munagala Seetamahalakshmi</strong>, grandmother of{' '}
                  <em>Munagala Gopinadh</em>. To honour her memory, the foundation prepared and served
                  nutritious meals to the students, ensuring they received wholesome and healthy food.
                </p>
              </div>
            </div>
            ...
            <p>
              ...
              <strong className="text-amber-900">love, care, and the spirit of giving</strong>. Viraga
              Foundation remains dedicated to its mission of supporting the needy through regular food
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 mt-10">
            {[
              ...
              <div
                key={s.label}
                className="rounded-xl sm:px-4 py-4 px-2 text-center"
                  ...
                  <div className="flex gap-2 mt-2">
                    ...
                    <ActionBtn
                      ...
                      onClick={(e) => {
                        ...
                        downloadMedia(
                          item.src,
                          `viraga-ferry-${item.id}${item.type === 'video' ? '.mp4' : '.jpg'}`,
                        );
                      }}
                    />
                  </div>
