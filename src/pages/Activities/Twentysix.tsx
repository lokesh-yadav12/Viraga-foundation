      ...
      >
        ...
        <div className="flex items-center justify-between w-full mb-3 px-1">
          ...
          <div className="flex gap-3">
            <button
              onClick={() =>
                downloadMedia(item.src, `viraga-vftl-${item.id}`)
              }
    ...
    <>
      ...
      >
        ...
        <section className="max-w-6xl mx-auto px-6 pt-10 pb-14">
          <SectionTitle
            icon="🏫"
            label="V F T L Registration, Class & Exam Pics"
          />
          <GalleryGrid
            items={block6Items}
            onOpen={(i) => setBlock6Lb(i)}
            prefix="viraga-block6"
          />
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 pt-14 pb-14">
          ...
          <GalleryGrid
            items={block5Items}
            onOpen={(i) => setBlock5Lb(i)}
            prefix="viraga-block5"
          />
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 pt-14 pb-20">
          ...
          <GalleryGrid
            items={block4Items}
            onOpen={(i) => setBlock4Lb(i)}
            prefix="viraga-block4"
          />
        </section>
