					...
					>
						<div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-xl p-6 sm:p-8 lg:p-10 border border-gray-200 hover:shadow-2xl transition-shadow duration-500">
							...
							<motion.button
								...
								whileTap={{ scale: 0.95 }}
								onClick={handleClick}
								className="mt-6 sm:mt-8 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-orange-400 to-orange-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base"
							>
								Learn More
							</motion.button>
						</div>
