  ...
  return (
    <div className="relative bg-slate-50 overflow-hidden sm:pt-20">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-40 -left-40 w-96 h-96 bg-blue-500/5 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '1s' }} />
          ...
          <div className="mx-auto max-w-6xl px-6 w-full">
            <div className="max-w-3xl space-y-6 animate-fade-in-up">
              ...
              <h1 className="text-4xl md:text-7xl font-bold text-white leading-tight">
                ...
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600 animate-slide-in-left" style={{ animationDelay: '0.2s' }}>
                  Excellence
                </span>
              </h1>
              
              {/* Description */}
              <p className="max-w-2xl text-lg md:text-xl text-slate-200 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="grid gap-8 grid-cols-1 lg:grid-cols-2">
            {members.map((member, index) => (
              ...
              >
                ...
                {/* Card Content */}
                <div className="relative flex flex-col sm:flex-row gap-6 p-8">
                  {/* Image Section */}
