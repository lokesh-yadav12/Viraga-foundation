...
const InitiativeCard: React.FC<InitiativeCardProps> = ({ initiative, index }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`group relative transition-all duration-700 ease-out cursor-pointer select-none ${
    ...
    >
      ...
      `}>
        ...
        {/* Content */}
        <div className="relative p-7 sm:p-8 flex flex-col items-center text-center z-10 pointer-events-none">
...
export default function SocialInitiativesFire() {
  ...
  return (
    <div className={`min-h-screen ${bgClass} py-16 sm:py-20 md:py-12 lg:py-12 relative overflow-hidden`}>
